        ...
        if layerFunctions is None:
            ...
            for i in range(self.layerCount):
                if i == self.layerCount - 1:
                    ...
                    lFuncs.append(TransferFunctions.sigmoid)
        else:
...
if __name__ == "__main__":
    ...
    # lFuncs = [None, TransferFunctions.tanh, TransferFunctions.tanh]
    lFuncs = [None, TransferFunctions.sigmoid, TransferFunctions.sigmoid]
    ...
    for i in range(lnMax+1):
        ...
        if i % 5000 == 0 and i > 0:
            print("Iteration {0:6d}K - Error: {1:0.10f}".format(int(i/1000), err))
        if err <= lnErr:
