...
def find_min(data_list, inde_index, depe_index, actual_values):
...
#    print('depe_variable: ', depe_index, ', inde_variable: ', inde_index)
    ...
    while abs( (actual_values[depe_index] - data_list[depe_index][-1])/actual_values[depe_index] ) > thresh:       # while the error in the results is above a threshold
        ...
        next_inde_guess = lin_inter( data_list[inde_index], data_list[depe_index], actual_values[depe_index] )
        ...
        if abs( actual_values[depe_index] - data_list[depe_index][0] ) < abs( actual_values[depe_index] - data_list[depe_index][1]):
        ...
        #print(abs( (actual_values[depe_index] - data_list[depe_index][-1])/actual_values[depe_index] ), thresh)
...
while found_min == False:
    for g in group_list:
        #print g
        data_list = find_min(data_list, g[0], g[1], actual_values)
    #print (actual_values[2] - data_list[2][-1])/actual_values[2]
    #print (actual_values[3] - data_list[3][-1])/actual_values[3]

    if abs( (actual_values[2] - data_list[2][-1])/actual_values[2]) < thresh and abs( (actual_values[3] - data_list[3][-1])/actual_values[3] ) < thresh:
        found_min = True
