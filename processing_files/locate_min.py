...
#        other_inde_index = 0
    ...
    for i in data_list[inde_index]:
        if inde_index == 0:
            ...
            radii_list = core_boundary + str(i)
            #radii_list = str(i)
    ...
    while abs( desired_y - data_list[depe_index][-1] ) > thresh:
        if data_list[depe_index][0] - data_list[depe_index][1] == 0:
            ...
            if data_list[depe_index][0] < 1:
                data_list[inde_index][1] = 1.1 * data_list[inde_index][1]
                ...
                data_list[inde_index][0] = .9 * data_list[inde_index][0]
            ...
            if data_list[depe_index][0] < 1:
                data_list[2][1] = final_radius
                data_list[3][1] = core_mass_frac_ratio

            elif data_list[depe_index][0] > 1:
                data_list[2][0] = final_radius
                data_list[3][0] = core_mass_frac_ratio
        ...
        if inde_index == 0:
            ...
            radii_list = core_boundary + str(next_inde_guess)
            pressure = str( data_list[other_inde_index][-1] )
